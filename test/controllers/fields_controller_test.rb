...
class FieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post fields_url, params: { field: { name: @field.name, platform: @field.platform, synchronization_id: @field.synchronization_id } }
    end
  ...
  test "should update field" do
    patch field_url(@field), params: { field: { name: @field.name, platform: @field.platform, synchronization_id: @field.synchronization_id } }
